 ...
 * @author maruhachi
 */
public class Strategy_D_macd_plugin extends StrategyTemplate implements Runnable {
    ...
    public Strategy_D_macd_plugin(OandaAutoTrader OAT, CompletableFuture<double[]> future) {
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(Strategy_D_macd_plugin.class.getName()).log(Level.SEVERE, null, ex);
        }
